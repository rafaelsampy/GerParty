...
<html>
	<head>
		...
		$(document).ready(function(){
			...
			$('div[name=excluir]').click( function(){
				id = $(this).attr("id").split("-");
				jConfirm('Tem certeza que deseja excluir essa venda ?', 'Excluir Venda',function(result){
					if(result){
						window.location = "model/excluir.php?acao=excluir_venda&id="+id[0];
					}
				});
			});
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-shopping-cart default-color"></i> Listar Vendas</h2>
				</div>
				<div class="row">
								...
								<div id="grid" class="col-sm-12 col-md-12 col-lg-12" style="display:block; margin-top:15px;">	
									<table id="tabela" class="col-sm-12 col-md-12 col-lg-12">
										<thead style="width:100%; background-color:#ececec;">
											<tr style="width:100%;">
												<th style="width:5%; text-align:center; line-height: 28px;">#</th>
												<th style="width:15%; text-align:center; line-height: 28px;">N° Identidicador</th>
												<th style="width:10%; text-align:center; line-height: 28px;">Nome</th>
												<th style="width:10%; text-align:center; line-height: 28px;">Produto</th>
												<th style="width:10%; text-align:center; line-height: 28px;">Valor</th>
												<th style="width:10%; text-align:center; line-height: 28px;">Quantidade</th>
												<th style="width:10%; text-align:center; line-height: 28px;">Valor Total</th>
												<th style="width:10%; text-align:center; line-height: 28px;">Data Venda</th>
										...
										<tbody>
											...
											if(isset($r['valor_produto']) && isset($r['quantidade'])){
												$valor_total = $r['quantidade'] * $r['valor_produto'];
											}
											$count--;?>
											<tr style="width:100%;">
												<td style="width:5%; text-align:center; background-color:#fff;"><?php echo isset($count)?$count:"-";?></td>
												<td style="width:15%; text-align:center; background-color:#fff;"><?php echo isset($r['numero_identificador'])?$r['numero_identificador']:"-";?></td>
												<td style="width:15%; text-align:center; background-color:#fff;"><?php echo isset($r['nome_completo'])?$r['nome_completo']:"-";?></td>
												<td style="width:10%; text-align:center; background-color:#fff;"><?php echo isset($r['nome_produto'])?$r['nome_produto']:"-";?></td>
												<td style="width:10%; text-align:center; background-color:#fff;"><?php echo isset($r['valor_produto'])?$r['valor_produto']:"-";?></td>
												<td style="width:10%; text-align:center; background-color:#fff;"><?php echo isset($r['quantidade'])?$r['quantidade']:"-";?></td>
												<td style="width:10%; text-align:center; background-color:#fff;"><?php echo isset($valor_total)?number_format($valor_total, 2,'.',''):"-";?></td>
												<td style="width:10%; text-align:center; background-color:#fff;"><?php echo isset($r['data_venda'])?date_format(date_create($r['data_venda']), 'd/m/Y'):"-";?></td>

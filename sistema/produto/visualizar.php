...
<html>
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-cubes default-color"></i> Visualizar Produto</h2>
				</div>
				<div class="row">
								...
								<form class="form-signin" id="form-signin" action="listar.php" method="POST">	
									<div class="col-sm-12 col-md-12 col-lg-12">
										...
										<div class="col-sm-8 col-md-8 col-lg-8">
											...
											<input id="nome" type="text" class="form-control" name="nome" readonly value="<?php echo isset($r['nome'])?$r['nome']:""?>"/>
											<div id='resposta'></div>
										</div>
										<div class="col-sm-4 col-md-4 col-lg-4">
											<label for="valor">Valor: </label>
											<input id="valor" type="text" class="form-control" name="valor" readonly value="<?php echo isset($r['valor'])?$r['valor']:""?>"/>
										</div>
										<h3 class="col-sm-12 col-md-12 col-lg-12 text-left" style="margin-top:30px;">Categoria</h3>
										<div class="form-group col-sm-12 col-md-12 col-lg-12">
											<label for="categoria">Categoria: </label>
											<input id="categoria" type="text" class="form-control" name="categoria" readonly value="<?php echo isset($r['categoria'])?$r['categoria']:""?>"/>
										</div>

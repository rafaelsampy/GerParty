...
<html>
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-cubes default-color"></i> Editar Produto</h2>
				</div>
				<div class="row">
					<div class="panel panel-default" style="background-color: #f9f9f9;">
						<div class="panel-body">
							<?php if($p['permissao_produto'] == 1){ ?>
								<form class="form-signin" id="form-signin" action="./model/editar.php?acao=alterar_produto&id=<?php echo $_GET['id']?>" method="POST">	
									<div class="col-sm-12 col-md-12 col-lg-12">
										<h3 class="col-sm-12 col-md-12 col-lg-12 text-left" style="">Dados do Produto</h3>
										<div class="col-sm-8 col-md-8 col-lg-8">
											<label for="nome">Nome: </label>
											<input id="nome" type="text" class="form-control" name="nome" readonly placeholder="" required="" value="<?php echo isset($r['nome'])?$r['nome']:""?>"/>
											<div id='resposta'></div>
										</div>
										<div class="col-sm-4 col-md-4 col-lg-4">
											<label for="valor">Valor: </label>
											<input id="valor" type="text" class="form-control" name="valor" placeholder="" required="" autofocus="" value="<?php echo isset($r['valor'])?$r['valor']:""?>"/>
										</div>
										...
										<div class="form-group col-sm-12 col-md-12 col-lg-12">
											<select class="form-control" id="categoria" name="categoria"  placeholder="" required="" autofocus="" >
												<?php foreach($categoria as $c){
													if($c['id'] == $r['id_categoria']){
														$aux ="selected='selected'";
													}else{
														$aux ="";
													}
													echo "<option value='".$c['id']."'".$aux.">".$c['nome']."</option>";
												}?>
											</select>
										</div>

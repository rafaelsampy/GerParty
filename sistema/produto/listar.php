...
<html>
	<head>
		...
		$(document).ready(function(){
			...
			$('div[name=excluir]').click( function(){
				id = $(this).attr("id").split("-");
				jConfirm('Tem certeza que deseja excluir esse produto ?', 'Excluir Produto',function(result){
					if(result){
						window.location = "model/excluir.php?acao=excluir_produto&id="+id[0];
					}
				});
			});
	...
	<body>
	    <div id="wrapper">
	                    ...
	                    <ul class="nav" id="side-menu">
	                        ...
	                        <li>
	                            ...
	                            <ul class="nav nav-second-level">
	                                ...
	                                <li>
	                                    <a href="../produto/listar.php" class="active">Listar</a>
	                                </li>
	                            </ul>
	                        </li>
	                        <?php } ?>
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-cubes default-color"></i> Listar Produtos</h2>
				</div>
				<div class="row">
									...
									<table id="tabela" class="col-sm-12 col-md-12 col-lg-12">
										<thead style="width:100%;  background-color:#ececec;">
											<tr style="width:100%;">
												...
												<th style="width:20%; text-align:center; line-height: 28px;">Categoria</th>
												<th style="width:20%; text-align:center; line-height: 28px;">Valor</th>
										...
										<tbody>
											...
											<tr style="width:100%;">
												...
												<td style="width:30%; text-align:center; background-color:#fff;"><?php echo isset($r['nome'])?$r['nome']:"-";?></td>
												<td style="width:20%; text-align:center; background-color:#fff;"><?php echo isset($r['categoria'])?$r['categoria']:"-";?></td>
												<td style="width:20%; text-align:center; background-color:#fff;"><?php echo isset($r['valor'])?$r['valor']:"-";?></td>

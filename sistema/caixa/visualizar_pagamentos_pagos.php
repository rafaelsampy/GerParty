<?php require('./controller/visualizar_pagamentos_pagos.php');?>
<html>
	<head>
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-dollar default-color"></i> Visualizar Pagamento Pago</h2>
				</div>
				<div class="row">
					<div class="panel panel-default" style="background-color: #f9f9f9;">
						<div class="panel-body">
							<?php if($p['permissao_caixa'] == 1){ ?>
								<form class="form-signin" id="form-signin" action="pagamentos_pagos.php" method="POST">	
									<div class="col-sm-12 col-md-12 col-lg-12">
										...
										<div class="col-sm-3 col-md-3 col-lg-3">
											...
											<input id="data_pagamento" type="text" class="form-control" name="data_pagamento" readonly value="<?php echo isset($r['data_pagamento'])?date_format(date_create($r['data_pagamento']), 'd/m/Y'):""?>"/>
										</div>
										...
										<div class="col-sm-10 col-md-10 col-lg-10" style="margin-top:10px;"></div>

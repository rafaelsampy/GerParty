<?php require('./controller/pagamentos_pendentes.php');?>
<html>
	<head>
		...
		$(document).ready(function(){
			...
			$("div[name=visualizar]").click(function(e){
				...
				window.location = "visualizar_pagamentos_pendentes.php?id="+id[0];
			});
			
			$("div[name=pagar]").click(function(e){
				id = $(this).attr("id").split("-");
				window.location = "pagar_pagamentos_pendentes.php?id="+id[0];
			});
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-dollar default-color"></i> Listar Pagamentos Pendentes</h2>
				</div>
				<div class="row">
									...
									<table id="tabela" class="col-sm-12 col-md-12 col-lg-12">
										<thead style="width:100%; background-color:#ececec;">
											<tr style="width:100%;">
												...
												<th style="width:10%; text-align:center; line-height: 28px;">N° Identidicador</th>
												<th style="width:25%; text-align:center; line-height: 28px;">Nome</th>
												<th style="width:15%; text-align:center; line-height: 28px;">RG</th>
												<th style="width:15%; text-align:center; line-height: 28px;">Idade</th>
											...
											<tr style="width:100%;">
												...
												<th style="width:25%; text-align:center;"><input type="text" style="width:97%; margin:2px;"/></th>
												<th style="width:15%; text-align:center;"><input type="text" style="width:97%; margin:2px;"/></th>
												<th style="width:10%; text-align:center;"><input type="text" style="width:97%; margin:2px;"/></th>
												<th style="width:10%; text-align:center;"><input type="text" style="width:97%; margin:2px;"/></th>
												<th style="width:12%; text-align:center; line-height: 28px;"></th>
											</tr>            
										</thead>
										<tbody>
											<?php foreach($result as $r){ 
												...
												<tr style="width:100%;">
													...
													<td style="width:25%; text-align:center; background-color:#fff;"><?php echo isset($r['nome_completo'])?$r['nome_completo']:"-";?></td>
													...
													<td style="width:10%; text-align:center; background-color:#fff;"><?php echo isset($r['valor_total'])?number_format($r['valor_total'], 2,'.',''):"-";?></td>
													<td style="width:15%; text-align:center; background-color:#fff;">
														<div id="<?php echo $r['id']?>-visualizar" name="visualizar" class="fa fa-eye fa-fw" style="width:50%; height:29px; float:left; text-align:center;  white-space: nowrap;  line-height: 28px; font-size: 15px; background-color:#fff;" title="Visualizar"></div>
														<div id="<?php echo $r['id']?>-pagar" name="pagar" class="fa fa-dollar fa-fw" style="width:50%; height:29px; float:left; text-align:center; border-left:1px solid #000; white-space: nowrap; line-height: 28px; font-size: 15px; background-color:#fff;" title="Pagar"></div>	
													</td>
												</tr>
											<?php } ?>
										</tbody>

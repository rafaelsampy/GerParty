<?php 
	...
	if(isset($_SESSION['id_usuario'])){ 
		...
		$result = $db->getRows("SELECT c.id AS id, c.nome_completo AS nome_completo, c.numero_identificador AS numero_identificador, c.data_nascimento AS data_nascimento, c.rg AS rg, v.data_pagamento AS data_pagamento
								FROM tbl_venda AS v 

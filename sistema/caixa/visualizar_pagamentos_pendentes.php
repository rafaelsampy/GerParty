<?php require('./controller/visualizar_pagamentos_pendentes.php');?>
<html>
	<head>
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-dollar default-color"></i> Visualizar Pagamento Pendente</h2>
				</div>
				<div class="row">
					<div class="panel panel-default" style="background-color: #f9f9f9;">
						<div class="panel-body">
							<?php if($p['permissao_caixa'] == 1){ ?>
								<form class="form-signin" id="form-signin" action="pagamentos_pendentes.php" method="POST">	

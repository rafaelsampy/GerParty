...
<html>
		...
		<script language="javascript">
			$(document).ready(function(){
				$("#email_login").blur(function(){
					...
					$.ajax({ 
						url: 'model/pesquisar.php?acao=verificar_email_login', 
						type: 'POST', 
						data:{"email_login" : email_login.val()}, 
						success: function(data){ 
							data = $.parseJSON(data); 
							$("#resposta").text(data.email_login);
							$("#email_login").val("");
						}
					});
				});
				
				$("#nome_completo").blur(function(){
					var nome_completo = $("#nome_completo");
					$.ajax({ 
						url: 'model/pesquisar.php?acao=verificar_nome_completo', 
						type: 'POST', 
						data:{"nome_completo" : nome_completo.val()}, 
						success: function(data){ 
							data = $.parseJSON(data); 
							$("#resposta_2").text(data.nome_completo);
							$("#nome_completo").val("");
						}
					});
				});
	...
	<body>
	    <div id="wrapper">
	                ...
	                <div class="sidebar-nav navbar-collapse">
	                    <ul class="nav" id="side-menu">
	                        ...
	                        <li>
	                            ...
	                            <ul class="nav nav-second-level">
	                                <li>
	                                    <a href="../usuario/cadastrar.php" class="active">Cadastrar</a>
	                                </li>
	                                <li>
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-user default-color"></i> Cadastrar Usuário</h2>
				</div>
				<div class="row">
					<div class="panel panel-default" style="background-color: #f9f9f9;">
						<div class="panel-body">
							<?php if($p['permissao_usuario'] == 1){ ?>
								<form class="form-signin" id="form-signin" action="./model/inserir.php?acao=cadastrar_usuario" method="POST">	
									<div class="col-sm-12 col-md-12 col-lg-12">
										...
										<div class="col-sm-4 col-md-4 col-lg-4" style="margin-top:10px;">
											...
											<input id="telefone_2" type="text" class="form-control" name="telefone_2" placeholder="" value=""/>
										</div>
										<h3 class="col-sm-12 col-md-12 col-lg-12 text-left" style="margin-top:30px;">Login</h3>
										<div class="col-sm-12 col-md-12 col-lg-12">
											<label for="email_login">E-mail: </label>
											<input id="email_login" type="email" class="form-control" name="email_login" placeholder="" required="" autofocus="" value=""/>
											<div id='resposta'></div>
										</div>
										<div class="col-sm-12 col-md-12 col-lg-12" style="margin-top:10px;">
											<label for="senha_login">Senha: </label>
											<input id="senha_login" type="text" class="form-control" name="senha_login" placeholder="" required="" value=""/>   
										</div>
										...
										<div class="checkbox col-sm-12 col-md-12 col-lg-12">
											<div class="col-sm-3 col-md-3 col-lg-3">
												<label><input id="permissao_cliente" type="checkbox" name="permissao_cliente" value="1">Cliente</label>
											</div>
											<div class="col-sm-3 col-md-3 col-lg-3">
												<label><input id="permissao_categoria" type="checkbox" name="permissao_categoria" value="1">Categoria</label>
											</div>
											<div class="col-sm-3 col-md-3 col-lg-3">
												<label><input id="permissao_produto" type="checkbox" name="permissao_produto" value="1">Produto</label>
											</div>
											<div class="col-sm-3 col-md-3 col-lg-3">
												<label><input id="permissao_venda" type="checkbox" name="permissao_venda" value="1">Venda</label>
											</div>
											<div class="col-sm-3 col-md-3 col-lg-3">
												<label><input id="permissao_caixa" type="checkbox" name="permissao_caixa" value="1">Caixa</label>
											</div>
											<div class="col-sm-3 col-md-3 col-lg-3">
												<label><input id="permissao_relatorio" type="checkbox" name="permissao_relatorio" value="1">Relatório</label>
											</div>
											<div class="col-sm-3 col-md-3 col-lg-3">
												<label><input id="permissao_usuario" type="checkbox" name="permissao_usuario" value="1">Usuário</label>
											</div>
											<div class="col-sm-3 col-md-3 col-lg-3">
												<label><input id="permissao_email" type="checkbox" name="permissao_email" value="1">E-mail</label>
											</div>
											<div class="col-sm-3 col-md-3 col-lg-3">
												<label><input id="permissao_blobo_notas" type="checkbox" name="permissao_blobo_notas" value="1">Bloco de Notas</label>
											</div>

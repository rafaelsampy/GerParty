...
<html>
	<head>
		...
		$(document).ready(function(){
			...
			$("div[name=excluir]").click(function(e){
				id = $(this).attr("id").split("-");
				jConfirm('Tem certeza que deseja excluir esse cliente ?', 'Excluir Cliente',function(result){
					if(result){
						window.location = "model/excluir.php?acao=excluir_cliente&id="+id[0];
					}
				});
			});
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-users default-color"></i> Listar Clientes</h2>
				</div>
				<div class="row">
									...
									<table id="tabela" class="col-sm-12 col-md-12 col-lg-12">
										<thead style="width:100%;  background-color:#ececec;">
											<tr style="width:100%;">
												...
												<th style="width:15%; text-align:center; line-height: 28px;">N° Identificador</th>
										...
										<tbody>
											<?php foreach($result as $r){ 
												...
												<tr style="width:100%;">
													...
													<td style="width:15%; text-align:center; background-color:#fff;"><?php echo isset($r['data_nascimento'])?$idade<0?0:$idade:"-";?></td>

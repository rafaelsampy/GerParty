<?php 
	...
	if(isset($_SESSION['id_usuario'])){ 
		...
		$result = $db->getRows("SELECT * FROM tbl_cliente ORDER BY id DESC");
		...
		if(isset($_GET['erro'])){
			...
			if($_GET['msg'] == "success"){
				...
				$mensagem = '<div class="alert alert-success .alert-dismissable col-sm-12 col-md-12 col-lg-12">
								<a class="close" data-dismiss="alert" aria-label="close">&times;</a>Cliente alterado com <strong>Sucesso</strong>
							</div>';
			}else {
				$mensagem = "";
			}

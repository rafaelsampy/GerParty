...
<html>
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-users default-color"></i> Editar Cliente</h2>
				</div>
				<div class="row">
					<div class="panel panel-default" style="background-color: #f9f9f9;">
						<div class="panel-body">
							<?php if($p['permissao_cliente'] == 1){ ?>
								<form class="form-signin" id="form-signin" action="./model/editar.php?acao=alterar_cliente&id=<?php echo $_GET['id']?>" method="POST">
									<div class="col-sm-12 col-md-12 col-lg-12"> 
										...
										<div class="col-sm-6 col-md-6 col-lg-6" style="margin-top:10px;">
											...
											<input id="email" type="email" class="form-control" name="email"  placeholder="" required="" autofocus="" value="<?php echo isset($r['email'])?$r['email']:""?>"/>
										</div>
										...
										<div class="col-sm-6 col-md-6 col-lg-6">
											...
											<input id="numero_identificador" type="text" class="form-control" name="numero_identificador" placeholder="" required="" autofocus="" <?php echo $readonly?> value="<?php echo isset($numero_identificador)?$numero_identificador:""?>"/>

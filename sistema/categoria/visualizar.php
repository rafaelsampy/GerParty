...
<html>
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-cube default-color"></i> Visualizar Categoria</h2>
				</div>
				<div class="row">
							...
							<?php if($p['permissao_categoria'] == 1){ ?>
								<form class="form-signin" id="form-signin" action="listar.php" method="POST">
									<div class="col-sm-12 col-md-12 col-lg-12">
										...
										<div class="col-sm-12 col-md-12 col-lg-12">
											<textarea id="observacao" class="form-control" rows="5" name="observacao" readonly value=""><?php echo isset($r['observacao'])?$r['observacao']:""?></textarea>
										</div>

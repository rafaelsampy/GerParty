...
<html>
	<head>
		...
		$(document).ready(function(){
			...
			$('div[name=excluir]').click( function(){
				id = $(this).attr("id").split("-");
				jConfirm('Tem certeza que deseja excluir essa categoria ?', 'Excluir Categoria',function(result){
					if(result){
						window.location = "model/excluir.php?acao=excluir_categoria&id="+id[0];
					}
				});
			});
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-cube default-color"></i> Listar Categorias</h2>
				</div>
				<div class="row">
									...
									<table id="tabela" class="col-sm-12 col-md-12 col-lg-12">
										<thead style="width:100%;  background-color:#ececec;">
											<tr style="width:100%;">
												...
												<th style="width:70%; text-align:center; line-height: 28px;">Nome</th>
												<th style="width:15%; text-align:center; line-height: 28px;">Ações</th>
											</tr>
											<tr style="width:100%;">
												<th style="width:15%; text-align:center; line-height: 28px;"></th>
												<th style="width:70%; text-align:center;"><input type="text" style="width:97%; margin:2px;"/></th>
												<th style="width:15%; text-align:center; line-height: 28px;"></th>
											</tr>            
										</thead>
										<tbody>
											...
											<tr style="width:100%;">
												...
												<td style="width:70%; text-align:center; background-color:#fff;"><?php echo isset($r['nome'])?$r['nome']:"-";?></td>

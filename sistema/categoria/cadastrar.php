...
<html>
	...
	<body>
	    <div id="wrapper">
	                ...
	                <div class="sidebar-nav navbar-collapse">
	                    <ul class="nav" id="side-menu">
	                        ...
	                        <li>
	                            ...
	                            <ul class="nav nav-second-level">
	                                <li>
	                                    <a href="../categoria/cadastrar.php" class="active">Cadastrar</a>
	                                </li>
	                                <li>
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-cube default-color"></i> Cadastrar Categoria</h2>
				</div>
				<div class="row">
					<div class="panel panel-default" style="background-color: #f9f9f9;">
						<div class="panel-body">
							<?php if($p['permissao_categoria'] == 1){ ?>
								<form class="form-signin" id="form-signin" action="./model/inserir.php?acao=cadastrar_categoria" method="POST">	

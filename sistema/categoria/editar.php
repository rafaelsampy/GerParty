...
<html>
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-cube default-color"></i> Editar Categoria</h2>
				</div>
				<div class="row">
							...
							<?php if($p['permissao_categoria'] == 1){ ?>
								<form class="form-signin" id="form-signin" action="./model/editar.php?acao=alterar_produto&id=<?php echo $_GET['id']?>" method="POST">
									<div class="col-sm-12 col-md-12 col-lg-12">
										<h3 class="col-sm-12 col-md-12 col-lg-12 text-left" style="">Dados da Categoria</h3>
										<div class="col-sm-12 col-md-12 col-lg-12">
											<label for="nome">Nome: </label>
											<input id="nome" type="text" class="form-control" name="nome" readonly placeholder="" required="" autofocus="" value="<?php echo isset($r['nome'])?$r['nome']:""?>"/>
											<div id='resposta'></div>
										</div>
										<h3 class="col-sm-12 col-md-12 col-lg-12 text-left" style="margin-top:30px;">Observação</h3>
										<div class="col-sm-12 col-md-12 col-lg-12">
											<textarea id="observacao" class="form-control" rows="5" name="observacao"  value=""><?php echo isset($r['observacao'])?$r['observacao']:""?></textarea>
										</div>

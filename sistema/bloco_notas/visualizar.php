...
<html>
		...
		<script language="javascript">
			$(document).ready(function(){
				$("#btn_print").click(function(e){
					window.open('print.php?id=<?php echo $_GET['id']?>', '_blank');
				});
			});
		</script>
	</head>
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-file-text default-color"></i> Visualizar Bloco de Nota</h2>
				</div>
				<div class="row">
								...
								<form class="form-signin" id="form-signin" action="listar.php" method="POST">
									<div class="col-sm-12 col-md-12 col-lg-12">
										<div class="col-sm-12 col-md-12 col-lg-12">
											...
											<input id="nome" type="text" class="form-control" name="nome" readonly value="<?php echo isset($r['assunto'])?$r['assunto']:""?>"/>
											<div id='resposta'></div>
										</div>
										<div class="col-sm-12 col-md-12 col-lg-12" style="margin-top:10px;">
											<label for="observacao">Texto: </label>
											<textarea id="observacao" class="form-control" rows="5" name="observacao" readonly value=""><?php echo isset($r['texto'])?$r['texto']:""?></textarea>
										</div>

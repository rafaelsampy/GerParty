...
<html>
	<head>
		...
		$(document).ready(function(){
			...
			$("div[name=imprimir]").click(function(e){
				id = $(this).attr("id").split("-");
				window.open('print.php?id='+id[0], '_blank');
			});
			
			$('div[name=excluir]').click( function(){
				id = $(this).attr("id").split("-");
				jConfirm('Tem certeza que deseja excluir esse bloco de nota ?', 'Excluir Bloco de Nota',function(result){
					if(result){
						window.location = "model/excluir.php?acao=excluir_bloco_nota&id="+id[0];
					}
				});
			});
	...
	<body>
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-file-text default-color"></i> Listar Bloco de Notas</h2>
				</div>
				<div class="row">
									...
									<table id="tabela" class="col-sm-12 col-md-12 col-lg-12">
										<thead style="width:100%; background-color:#ececec;">
											<tr style="width:100%;">
												...
												<th style="width:65%; text-align:center; line-height: 28px;">Assunto</th>
												<th style="width:20%; text-align:center; line-height: 28px;">Ações</th>
											</tr>
											<tr style="width:100%;">
												<th style="width:15%; text-align:center; line-height: 28px;"></th>
												<th style="width:65%; text-align:center;"><input type="text" style="width:97%; margin:2px;"/></th>
												<th style="width:20%; text-align:center; line-height: 28px;"></th>
											</tr>            
										</thead>
										<tbody>
											...
											<tr style="width:100%;">
												...
												<td style="width:65%; text-align:center; background-color:#fff;"><?php echo isset($r['assunto'])?$r['assunto']:"-";?></td>
												<td style="width:20%; text-align:center; background-color:#fff;">
													<div id="<?php echo $r['id']?>-visualizar" name="visualizar" class="fa fa-eye fa-fw" style="width:25%; height:29px; float:left; text-align:center; white-space: nowrap;  line-height: 28px; font-size: 15px; background-color:#fff;" title="Visualizar"></div>
													<div id="<?php echo $r['id']?>-editar" name="editar" class="fa fa-pencil fa-fw" style="width:25%; height:29px; float:left; text-align:center; border-left:1px solid #000; white-space: nowrap;  line-height: 28px; font-size: 15px; background-color:#fff;" title="Editar"></div>	
													<div id="<?php echo $r['id']?>-excluir" name="excluir" class="fa fa-trash-o fa-fw" style="width:25%; height:29px; float:left; text-align:center; border-left:1px solid #000; white-space: nowrap; line-height: 28px; font-size: 15px; background-color:#fff;" title="Excluir"></div>
													<div id="<?php echo $r['id']?>-imprimir" name="imprimir" class="fa fa-print fa-fw" style="width:25%; height:29px; float:left; text-align:center; white-space: nowrap; border-left:1px solid #000; line-height: 28px; font-size: 15px; background-color:#fff;" title="Imprimir"></div>
												</td>
											</tr>
											<?php } ?>
										</tbody>

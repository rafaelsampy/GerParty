...
<html>
	...
	<body>
	    <div id="wrapper">
	                    ...
	                    <ul class="nav" id="side-menu">
							...
							<?php if($p['permissao_blobo_notas'] == 1){ ?>
	                         <li>
	                            ...
	                            <ul class="nav nav-second-level">
	                                <li>
	                                    <a href="../bloco_notas/cadastrar.php" class="active">Cadastrar</a>
	                                </li>
	                                <li>
	        ...
	        <div id="page-wrapper">
				<div class="row">
					<h2 class="page-header"><i class="fa fa-file-text default-color"></i> Cadastrar Bloco de Nota</h2>
				</div>
				<div class="row">
					<div class="panel panel-default" style="background-color: #f9f9f9;">
						<div class="panel-body">
							<?php if($p['permissao_blobo_notas'] == 1){ ?>
								<form class="form-signin" id="form-signin" action="./model/inserir.php?acao=cadastrar_bloco_nota" method="POST">	
									<div class="col-sm-12 col-md-12 col-lg-12">
										...
										<div class="col-sm-12 col-md-12 col-lg-12" style="margin-top:10px;">
											...
											<textarea id="observacao" class="form-control" rows="10" name="observacao" placeholder="" required="" autofocus="" value=""></textarea>
										</div>
